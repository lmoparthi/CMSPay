...
#Region "Form Events"
    ...
    Public Sub PatientSelected(ByVal e As Object, ByVal dr As DataRow) Handles MemberSearchControl.ActionSelect
        ...
        Try
            ...
            If dr IsNot Nothing Then
                ...
                Else
                    _PartSSN = dr("PART_SSNO")
                End If

                _FirstName = dr("FIRST_NAME")
                _LastName = dr("LAST_NAME")
                _FamilyID = dr("FAMILY_ID")
                _RelationID = dr("RELATION_ID")
                _PatientRow = dr
    ...
    Private Sub SetSettings()
        ...
        Me.Top = IIf(CInt(GetSetting(_AppKey, Me.Name & "\Settings", "Top", Me.Top.ToString)) < 0, 0, CInt(GetSetting(_AppKey, Me.Name & "\Settings", "Top", Me.Top.ToString)))
        Me.Height = CInt(GetSetting(_AppKey, Me.Name & "\Settings", "Height", Me.Height.ToString))
        Me.Left = IIf(CInt(GetSetting(_AppKey, Me.Name & "\Settings", "Left", Me.Left.ToString)) < 0, 0, CInt(GetSetting(_AppKey, Me.Name & "\Settings", "Left", Me.Left.ToString)))
