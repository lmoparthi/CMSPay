...
Public Delegate Sub FormatCellEventHandler(ByVal sender As Object, ByVal e As ConfirmDeleteDataGridFormatCellEventArgs)
Public Delegate Sub FormatRowEventHandler(ByVal sender As Object, ByVal e As ConfirmDeleteDataGridFormatRowEventArgs)

<System.Diagnostics.DebuggerStepThrough()>
Public Class ConfirmDeleteDataGridFormattableMultiLineTextBoxColumn
...
<System.Diagnostics.DebuggerStepThrough()>
Public Class ConfirmDeleteDataGridFormattableTextBoxColumn
    Inherits ConfirmDeleteDataGridHighlightTextBoxColumn
    ...
    Protected Overloads Overrides Sub Paint(ByVal g As Graphics, ByVal bounds As Rectangle, ByVal source As CurrencyManager, ByVal rowNum As Integer, ByVal backBrush As Brush, ByVal foreBrush As Brush, ByVal alignToRight As Boolean)
        ...
        Dim DGCellArgs As ConfirmDeleteDataGridFormatCellEventArgs
        Dim ColumnValue As Object

        Try

            DGCellArgs = New ConfirmDeleteDataGridFormatCellEventArgs(rowNum, _Col, Me.Format, Me.DataGridTableStyle.DataGrid.Font, backBrush, foreBrush)
...
<System.Diagnostics.DebuggerStepThrough()>
Public Class ConfirmDeleteDataGridFormatCellEventArgs
    Inherits EventArgs
...
<System.Diagnostics.DebuggerStepThrough()>
Public Class ConfirmDeleteDataGridFormatRowEventArgs
    Inherits EventArgs
    Private _column As Integer
    Private _rowNumber As Integer
    Private _backBrush As Brush
