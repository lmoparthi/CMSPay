...
#End If
    ...
    Private Sub SyncAllowed(Optional ByVal detailLine As Short = -1)
        ...
        Try
            ...
            If _MedDtlBS Is Nothing OrElse _MedDtlBS.Count = 0 Then Exit Sub
            ...
            For Cnt As Integer = 0 To DV.Count - 1
                ...
                If Not IsDBNull(DV(Cnt)("PRICED_AMT")) AndAlso Not IsDBNull(DV(Cnt)("CHRG_AMT")) Then
                    If CDec(DV(Cnt)("PRICED_AMT")) < CDec(DV(Cnt)("CHRG_AMT")) Then
                        If Not IsDBNull(DV(Cnt)("ALLOWED_AMT")) Then
                            If CDec(DV(Cnt)("ALLOWED_AMT")) <> CDec(DV(Cnt)("PRICED_AMT")) Then
                    ...
                    Else
                        If Not IsDBNull(DV(Cnt)("ALLOWED_AMT")) Then
                            If CDec(DV(Cnt)("ALLOWED_AMT")) <> CDec(DV(Cnt)("CHRG_AMT")) Then
...
#End If
        ...
        Try
            ...
            If Not IsDate(txtToDate.Text) AndAlso DirectCast(Binding.DataSource, System.Windows.Forms.BindingSource).DataSource.ToString.ToUpper.Contains("MEDDTL") Then
...
#End If
    ...
    Private Sub PricedAmountTextBox_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPricedAmt.Validated
        ' -----------------------------------------------------------------------------
        ' <summary>
        ' forces changes to be updated to the dataset
        ' </summary>
