...
#End Region
    ...
    Private _ProvNPI As Decimal = Nothing
    Private _ProvName As String = Nothing
...
#End Region
    ...
    Private Sub ProviderLookUpForm_Shown(sender As Object, e As EventArgs) Handles Me.Shown
