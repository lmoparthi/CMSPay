...
#Region "Gets and Sets"
    Public Overridable Sub SetValue(ByVal dateOfValue As Date, ByVal amt As Decimal)
        ' -----------------------------------------------------------------------------
        ' <summary>
        ' Seys the value of the accumulator for the given date
        ' </summary>
    ...
    Private Shared Function GetDaysWithAmt(ByVal summaryDT As DataTable, ByVal dateType As DateType, ByVal daysToSearch As Integer, ByVal zeroDate As Date?, ByVal dateDirection As DateDirection) As ArrayList
        ' -----------------------------------------------------------------------------
        ' <summary>
        ' Gets the Days' value
        ' </summary>
