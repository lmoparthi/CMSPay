...
#Region "Public"
    ...
    Public Sub RefreshAccumulatorOOPSummariesForMember2Year(ByVal actionYear As Integer)
                    ...
                    For Each Str As String In DaysA
                        If Str IsNot Nothing Then
                            If Str.Length > 0 Then
                                ...
                                MemberAccumulator.SetCurrentValue(AddDate, Amt)
                                MemberAccumulator.SetValue(AddDate, Amt)
                            End If
                        End If
                    Next
...
#End If
        ...
        Try
            ...
            'get all the raw data
            AccumulatorsDS = MemberAccumulatorDAL.GetAccumulatorSummaries(_RelationID, _FamilyID, manualOnly)
            If AccumulatorsDS Is Nothing Then Return
            ...
            For I As Integer = 0 To AccumulatorsDS.Tables("AccumulatorSummary").Rows.Count - 1
                ...
                If MemberAccumulator IsNot Nothing Then MemberAccumulator = Nothing '.Dispose()

                DR = AccumulatorsDS.Tables("AccumulatorSummary").Rows(I)

                'see if an accumulator already exists with that id
                MemberAccumulator = CType(_AccumulatorCollection(DR("ACCUM_ID")), MemberAccumulator)
                ...
                Else
                    'create a new memberaccumulator
                    MemberAccumulator = New MemberAccumulator(CInt(DR("ACCUM_ID")), _RelationID, _FamilyID) ', dt)
                    If DR("DAYS_INFORMATION") IsNot System.DBNull.Value Then
                        Dim S() As String = CStr(DR("DAYS_INFORMATION")).Split(CChar(","))
                        Dim S2() As String
                        Dim Day As String
    ...
    Private Shared Function GetProposedValue(ByVal accumulator As MemberAccumulator, ByVal dateType As DateType, ByVal dateTypeQuantity As Integer, ByVal dateTypeStart As Date?, ByVal dateDirection As DateDirection) As Decimal
        ...
        Try
            ...
            Return Math.Round(accumulator.GetProposedValue(dateType, dateTypeQuantity, dateTypeStart, dateDirection), 2)
    ...
    Public Function GetProposedYearValue(ByVal accumulatorID As Integer, ByVal year As Integer) As Decimal
        ...
        Try
            ...
            Return Math.Round(GetMemberAccumulator(accumulatorID).ProposedYearValue(year), 2)
    ...
    Public Function GetProposedLifetimeValue(ByVal accumulatorID As Integer) As Decimal
        ...
        Try
            ...
            Return Math.Round(GetMemberAccumulator(accumulatorID).ProposedLifetimeValue, 2)
    ...
    Public Function GetOriginalLifetimeValue(ByVal accumulatorID As Integer) As Decimal
        ...
        Try
            Return Math.Round(GetMemberAccumulator(accumulatorID).OriginalLifetimeValue, 2)
    ...
    Public Function GetProposedRolloverValue(ByVal accumulatorID As Integer, ByVal year As Integer) As Decimal
        ...
        Try
            ...
            Return Math.Round(GetMemberAccumulator(accumulatorID).ProposedRolloverValue(year), 2)
    ...
    Public Function GetProposedCurrentValueForCurrentYear(ByVal accumulatorID As Integer) As Decimal
        ...
        Try
            ...
            Return Math.Round(GetMemberAccumulator(accumulatorID).ProposedCurrentValueForCurrentYear, 2)
    ...
    Public Function GetAccumulatorEntryValues(ByVal proposed As Boolean) As DataTable
        ...
        Try
            ...
            '       DTLAccumDT.Columns.Add("CLAIM_ID", T'ype.GetType("System.Int32"))
            '      DTLAccumDT.Columns.Add("ACCUM_NAME")
            '     DTLAccumDT.Columns.Add("ENTRY_VALUE", Type.GetType("System.Decimal"))
            '      DTLAccumDT.Columns.Add("OVERRIDE_SW")
            '      DTLAccumDT.Columns.Add("LINE_NBR", Type.GetType("System.Int16"))
            '      DTLAccumDT.Columns.Add("DISPLAY_ORDER", Type.GetType("System.Int32"))
            '      DTLAccumDT.Columns.Add("APPLY_DATE")
            ...
            Else
                ...
                For Each AccumEntryDR As DataRow In AccumEntriesDT.Rows
                    Dim AccumName As String = AccumulatorController.GetAccumulatorName(CInt(AccumEntryDR("ACCUM_ID")))
                    Dim LineNbr As Short = CShort(AccumEntryDR("LINE_NBR"))
                    Dim ClaimID As Int32 = CInt(AccumEntryDR("CLAIM_ID"))

                    Dim QueryAccum =
                        From Accum In AccumEntriesDT.AsEnumerable
                        Where Accum.RowState <> DataRowState.Deleted _
                        AndAlso Accum.Field(Of Short)("LINE_NBR") = LineNbr AndAlso Accum.Field(Of Integer)("CLAIM_ID") = ClaimID AndAlso Accum.Field(Of String)("ACCUM_NAME") = AccumName
                        Select Accum

                    Dim AccumDR As DataRow = QueryAccum.FirstOrDefault

                    If AccumDR IsNot Nothing Then

                        AccumDR("ENTRY_VALUE") = CDec(AccumEntryDR("ENTRY_VALUE")) + CDec(AccumDR("ENTRY_VALUE"))
                    Else
                        NewDR = DTLAccumDT.NewRow
                        NewDR("CLAIM_ID") = AccumEntryDR("CLAIM_ID")
                        NewDR("ACCUM_NAME") = AccumName
                        NewDR("ENTRY_VALUE") = AccumEntryDR("ENTRY_VALUE")
                        NewDR("OVERRIDE_SW") = AccumEntryDR("OVERRIDE_SW")
                        NewDR("LINE_NBR") = AccumEntryDR("LINE_NBR")
                        NewDR("APPLY_DATE") = AccumEntryDR("APPLY_DATE")
    ...
    Public Function GetAccumulatorEntryValues(ByVal proposed As Boolean, ByVal claimID As Integer) As DataTable
        ...
        Try
            ...
            '            AccumSummaryDT.Columns.Add("CLAIM_ID", System.Type.GetType("System.Int32"))
            '            AccumSummaryDT.Columns.Add("ACCUM_NAME", System.Type.GetType("System.String"))
            '            AccumSummaryDT.Columns.Add("ENTRY_VALUE", System.Type.GetType("System.Decimal"))
            '            AccumSummaryDT.Columns.Add("OVERRIDE_SW", System.Type.GetType("System.Boolean"))
            '            AccumSummaryDT.Columns.Add("LINE_NBR", System.Type.GetType("System.Int16"))
            '            AccumSummaryDT.Columns.Add("DISPLAY_ORDER", System.Type.GetType("System.Int32"))
            '            AccumSummaryDT.Columns.Add("APPLY_DATE", System.Type.GetType("System.DateTime"))

            If proposed Then
                AccumEntriesDT = AccumulatorController.GetAccumulators()

                'For Each AccumsDR As DataRow In AccumsDT.Rows
                '    If _AccumulatorCollection(AccumsDR("ACCUM_ID")) IsNot Nothing Then

                '        AccumEntriesDT = CType(_AccumulatorCollection(AccumsDR("ACCUM_ID")), MemberAccumulator).MemberAccumulatorEntries

                '        For Each AccumEntryDR As DataRow In AccumEntriesDT.Rows
                '            AccumName = AccumulatorController.GetAccumulatorName(CInt(AccumEntryDR("ACCUM_ID")))

                '            Dim QueryAccum = _
                '                From Accum In AccumEntriesDT.AsEnumerable _
                '                Where Accum.Field(Of Short)("LINE_NBR") = CShort(AccumEntryDR("LINE_NBR")) AndAlso Accum.Field(Of Integer)("CLAIM_ID") = CInt(AccumEntryDR("CLAIM_ID")) AndAlso Accum.Field(Of String)("ACCUM_NAME") = AccumName _
                '                Select Accum

                '            If QueryAccum.Count > 0 Then
                '                'Should only be 1 accum by name for proposed; DO NOTHING
                '                'AccumDV(0)("ENTRY_VALUE") += entries.Rows(j)("ENTRY_VALUE")
                '            Else
                '                NewDR = DTLAccumDT.NewRow
                '                NewDR("CLAIM_ID") = AccumEntryDR("CLAIM_ID")
                '                NewDR("ACCUM_NAME") = AccumulatorController.GetAccumulatorName(CInt(AccumEntryDR("ACCUM_ID")))
            ...
            For Each AccumEntrySum In QuerySumByLineAccum.AsEnumerable
                ...
                '   If AccumEntrySum.Group.Count > 1 Then Throw New ArgumentException("Unexpected result in Accumulator grouping")

                '                For Each DR As DataRow In AccumEntrySum.Group
            ...
            '    Dim QueryAccum = _
            '        From Accum In DTLAccumDT.AsEnumerable _
            '        Where Accum.Field(Of Short)("LINE_NBR") = CShort(AccumEntryDR("LINE_NBR")) AndAlso Accum.Field(Of String)("ACCUM_NAME") = AccumName _
            '        Select Accum
    ...
    '    Public Function CreateDetailsDataTable() As DataTable
    '
    '    Dim DTLAccumDT As New DataTable("DTL_ACCUMS")
    '
    '        Try
    '
    '            DTLAccumDT.Columns.Add("CLAIM_ID", System.Type.GetType("System.Int32"))
    '            DTLAccumDT.Columns.Add("ACCUM_NAME", System.Type.GetType("System.String"))
    '            DTLAccumDT.Columns.Add("ENTRY_VALUE", System.Type.GetType("System.Decimal"))
    '            DTLAccumDT.Columns.Add("OVERRIDE_SW", System.Type.GetType("System.Decimal"))
    '            DTLAccumDT.Columns.Add("LINE_NBR", System.Type.GetType("System.Int16"))
    '            DTLAccumDT.Columns.Add("DISPLAY_ORDER", System.Type.GetType("System.Int32"))
    '            DTLAccumDT.Columns.Add("APPLY_DATE", System.Type.GetType("System.DateTime"))
    '
    '            Return DTLAccumDT
    '
    '        Catch ex As Exception
    ...
    Public Function GetAccumulatorEntryValues(ByVal proposed As Boolean, ByVal claimID As Integer, ByVal lineNumber As Short) As DataTable
        ...
        Try
            ...
            '            DTLAccumDT.Columns.Add("ACCUM_NAME", System.Type.GetType("System.String"))
            '            DTLAccumDT.Columns.Add("ENTRY_VALUE", System.Type.GetType("System.Decimal"))
            '            DTLAccumDT.Columns.Add("OVERRIDE_SW", System.Type.GetType("System.Boolean"))
            '            DTLAccumDT.Columns.Add("LINE_NBR", System.Type.GetType("System.Int16"))
            '            DTLAccumDT.Columns.Add("DISPLAY_ORDER", System.Type.GetType("System.Int32"))
            '            DTLAccumDT.Columns.Add("APPLY_DATE", System.Type.GetType("System.DateTime"))
            '
