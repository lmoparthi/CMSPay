...
Public Class DataGridHighlightButtonColumn
    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean)
        ...
        If disposing Then
            RemoveHandler Me.TextBox.Leave, New EventHandler(AddressOf LeaveTextBox)
            RemoveHandler Me.TextBox.Enter, New EventHandler(AddressOf EnterTextBox)
            RemoveHandler Me.TextBox.KeyUp, New KeyEventHandler(AddressOf TextBoxKeyUp)
            RemoveHandler Me.TextBox.TextChanged, New EventHandler(AddressOf TextBoxStartEditing)
            RemoveHandler _ColumnButton.Leave, New EventHandler(AddressOf LeaveButton)
            RemoveHandler _ColumnButton.Click, New EventHandler(AddressOf ButtonStartEditing)
            RemoveHandler _ColumnButton.MouseUp, New MouseEventHandler(AddressOf Button_AfterClick)
            RemoveHandler _ColumnButton.TagChanged, AddressOf ButtonTagChanged


            RemoveHandler CType(_MyGrid, DataGridCustom).EnterPressed, New DataGridCustom.EnterPressedEventHandler(AddressOf Grid_EnterPressed)
