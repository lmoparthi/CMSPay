...
Public Class ParticipantLookUpForm
...
#Region "Form Events"
    ...
    Private Sub ParticipantLookUpForm_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Enter
