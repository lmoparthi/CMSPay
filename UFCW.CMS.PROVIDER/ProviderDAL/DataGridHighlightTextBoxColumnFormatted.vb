...
Public Class DataGridHighlightTextBoxColumnProvider
    Inherits System.Windows.Forms.DataGridTextBoxColumn

    Public Event ProviderCellFormat(ByVal Column As DataGridHighlightTextBoxColumnProvider, ByVal RowNum As Integer, ByRef Value As Object, ByRef NewFormat As String)
...
#End Region
    ...
    Protected Overrides Function GetColumnValueAtRow(ByVal cm As CurrencyManager, ByVal RowNum As Integer) As Object
        ...
        RaiseEvent ProviderCellFormat(Me, RowNum, CellValue, NewFormat)
